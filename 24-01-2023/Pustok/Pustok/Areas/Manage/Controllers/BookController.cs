...
namespace Pustok.Areas.Manage.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        public IActionResult Index(int page = 1)
        {
            ...
            //PaginatedList<Book> pagenatedBook = new PaginatedList<Book>(query.Skip((page-1)*5).Take(5).ToList(), query.Count(), page, 5);
            var paginatedBooks = PaginatedList<Book>.Create(query, 2, page);
